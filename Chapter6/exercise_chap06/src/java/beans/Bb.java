...
public class Bb {
    ...
    private static Map<String, Integer> sexItems;
        static {
            sexItems = new LinkedHashMap<>();
            sexItems.put("男性", 1);
            sexItems.put("女性", 2);
        }

    public Map<String, Integer> getSexItems() {
        return sexItems;
    }

    public static void setSexItems(Map<String, Integer> sexItems) {
        Bb.sexItems = sexItems;
    }
